...
class LamedQwenConfig(Qwen2Config):
    model_type = "lamed_qwen"


class LamedQwenModel(LamedMetaModel, Qwen2Model):
    config_class = LamedQwenConfig

    def __init__(self, config: Qwen2Config):
        super(LamedQwenModel, self).__init__(config)
...
class LamedQwenForCausalLM(LamedMetaForCausalLM, Qwen2ForCausalLM):
    ...
    def __init__(self, config):
        ...
        self.model = LamedQwenModel(config)
