...
class API:
    ...
    def process_messages(self,messages):
        ...
        if "messages" in messages:
            ...
            if "image" in messages:
                ...
                current_messages.append({"role":"user","content":[{"type":"image_url", "image_url":{"url":f"data:image/jpeg;base64,{image}"}},{"type":"text","text":prompt}]})
    ...
    def generate_output(self, messages, retry_num=50):
        ...
        while True:
            try:
                ...
                # print(response.json())
                # print(f"retry_count:{retry_count+1}")
