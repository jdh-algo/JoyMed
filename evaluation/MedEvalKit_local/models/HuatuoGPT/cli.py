...
class HuatuoChatbot():
    ...
    def init_components(self):
        ...
        if 'huatuogpt-vision-7b' in d.lower():
            ...
            from .model.language_model.llava_qwen2 import LlavaQwen2ForCausalLM as LlavaForCausalLM
            ...
            print(f'loading from {self.model_dir}')
            from .model.language_model.llava_llama import LlavaLlamaForCausalLM as LlavaForCausalLM
