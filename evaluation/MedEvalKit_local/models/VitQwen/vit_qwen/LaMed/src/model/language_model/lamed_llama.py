...
class LamedConfig(LlamaConfig):
    ...
    def _rope_scaling_validation(self):
        """Override to handle Llama 3.1's rope_scaling format"""
        if self.rope_scaling is None:
            return
        
        # Handle Llama 3.1 format: {'factor': 8.0, 'rope_type': 'llama3', ...}
        ...
        # Now call parent validation with converted format
        super()._rope_scaling_validation()
