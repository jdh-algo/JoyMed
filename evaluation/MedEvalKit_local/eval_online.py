...
from api_token import api_model, api_judge
...
def main():
    ...
    parser.add_argument('--model_name', type=str, default='Qwen2.5-VL',
                        help='name of model')
    parser.add_argument('--served_model_name', type=str, default='Qwen2.5-VL-7B-Instruct',
                        help='name of served model')
    ...
    parser.add_argument('--num_chunks', type=str, default="8")
    ...
    args.api_url = api_model[args.served_model_name]["API_URL"]
    args.token = api_model[args.served_model_name]["TOKEN"]
    ...
    os.environ["OPENAI_API_BASE"] = api_judge[args.judge_gpt_model]["API_URL"]
    os.environ["OPENAI_API_KEY"] = api_judge[args.judge_gpt_model]["TOKEN"]
