...
from ..utils import save_json,extract,judger,get_compare_messages,judge_open_end_vqa,judge_judgement,llm_as_judge
    ...
    def cal_metrics(self,out_samples):
        ...
        for i,out_sample in tqdm(enumerate(out_samples)):
            ...
            if "<answer>" in response:
                # print(">>>[VQA_RAD]: <answer> in out_sample")
                response = extract(response,"answer")
            elif extract_boxed_content(response)!= "None":
                # print(">>>[VQA_RAD]: <box> in  out_sample")
                response = extract_boxed_content(response)
            # else:
                # print(">>>[VQA_RAD]: out_sample")
