...
class MIR_3D(BaseDataset):
    ...
    def construct_messages(self,sample):
        ...
        prompt = f"You are a helpful assistant. Please generate a medical report for this {type} 3D CT scan."
    ...
    def cal_metrics(self,out_samples):
        ...
        #                                                 desc="Evaluating 3D-MIR predictions",
        #                                                 category_key='type',
