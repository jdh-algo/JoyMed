...
class CMB(BaseDataset):
    ...
    def load_data(self):
        ...
        # dataset = load_dataset("json", data_files=f"{self.dataset_path}/CMB-Exam/CMB-val/CMB-val-merge.json")
        # print(len(dataset))
        
        dataset_path = self.dataset_path
        json_path = os.path.join(dataset_path,"CMB-Exam/CMB-val/CMB-val-merge.json")
    ...
    def construct_messages(self,sample):
        ...
        choices = [option[a] for a in option]
        choices = [f"{a}.{option[a]}" for a in option]
